    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          ...
          backgroundColor: CUTheme.of(context).colorScheme.error,
        ),
      );
    }
  }
      ...
      body: ListView(
        ...
        children: [
          ...
          if (_depositError != null)
            CUCard(
              color: CUTheme.of(context).colorScheme.errorContainer,
              child: Padding(
                padding: const EdgeInsets.all(16),
                child: Row(
                  children: [
                    CUIcon(
                      Icons.error_outline,
                      color: CUTheme.of(context).colorScheme.onErrorContainer,
                    ),
            ...
            CUCard(
              color: CUTheme.of(context).colorScheme.tertiaryContainer,
              child: Padding(
                padding: const EdgeInsets.all(16),
                child: Row(
                  children: [
                    CUIcon(
                      Icons.info_outline,
                      color: CUTheme.of(context).colorScheme.onTertiaryContainer,
                    ),
                    const SizedBox(width: 12),
                    Expanded(
                      child: Text(
                ...
                children: [
                  Row(
                    children: [
                      CUIcon(
                        Icons.help_outline,
                        color: CUTheme.of(context).colorScheme.primary,
                      ),
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              color: CUTheme.of(context).colorScheme.primaryContainer,
            ...
            child: Center(
              child: Text(
                number,
                style: TextStyle(
                  color: CUTheme.of(context).colorScheme.onPrimaryContainer,
          ...
          child: Column(
            children: [
              ...
              Container(
                ...
                height: 4,
                decoration: BoxDecoration(
                  color: CUTheme.of(context).colorScheme.outline,
                              ...
                              leading: CircleAvatar(
                                backgroundColor: deposit.status == CheckDepositStatus.completed
                                    ...
                                    : deposit.status == CheckDepositStatus.failed
                                        ? CUTheme.of(context).colorScheme.error
                                        : CUTheme.of(context).colorScheme.primary,
                                child: CUIcon(
