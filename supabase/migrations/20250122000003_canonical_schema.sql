...
-- Generated at: 2025-12-23T15:29:38.334Z
--
...
CREATE TABLE IF NOT EXISTS cu_os.credit_card_accounts_cu_os (
  ...
  next_statement_date TIMESTAMPTZ,
...
CREATE TABLE IF NOT EXISTS cu_os.loan_accounts_cu_os (
  ...
  escrow_analysis_date TIMESTAMPTZ,
...
CREATE TABLE IF NOT EXISTS public.authorized_third_parties (
  ...
  created_at TIMESTAMPTZ,
  fdx_certification_date TIMESTAMPTZ,
...
CREATE TABLE IF NOT EXISTS public.iso20022_account_statements (
  ...
  closing_balance_date TIMESTAMPTZ,
  created_at TIMESTAMPTZ,
  currency_code TEXT,
  entry_count NUMERIC,
...
CREATE TABLE IF NOT EXISTS public.iso20022_credit_transfers (
  ...
  interbank_settlement_date TIMESTAMPTZ,
  message_id UUID,
  metadata JSONB,
...
CREATE TABLE IF NOT EXISTS public.iso20022_direct_debits (
  ...
  mandate_signature_date TIMESTAMPTZ,
  message_id UUID,
  metadata JSONB,
  payment_info_id UUID NOT NULL,
  remittance_info TEXT,
  requested_collection_date TIMESTAMPTZ,
  sequence_type TEXT,
  status TEXT,
  tenant_id UUID
);
...
CREATE TABLE IF NOT EXISTS public.iso20022_payment_initiations (
  ...
  purpose_code TEXT,
  remittance_info TEXT,
  requested_execution_date TIMESTAMPTZ,
  status TEXT,
  tenant_id UUID
);
...
CREATE TABLE IF NOT EXISTS public.recurring_transfers (
  ...
  from_account_id UUID NOT NULL,
  member_id UUID NOT NULL,
  next_transfer_date TIMESTAMPTZ NOT NULL,
  status TEXT,
  to_account_id UUID NOT NULL,
...
CREATE TABLE IF NOT EXISTS realtime.subscription (
  ...
  filters DATABASE["REALTIME"]["COMPOSITETYPES"]["USER_DEFINED_FILTER"][] NOT NULL,
