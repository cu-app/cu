        ...
        child: Container(
          ...
          child: CustomScrollView(
            slivers: [
              ...
              SliverToBoxAdapter(
                child: Padding(
                  padding: EdgeInsets.fromLTRB(CUSpacing.lg, CUSpacing.xl, CUSpacing.lg, 0),
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text(
                      ...
                      _CategoryCheckbox(
                        ...
                        icon: CUIcons.accountBalanceWallet,
              ...
              SliverToBoxAdapter(
                child: Padding(
                  padding: EdgeInsets.fromLTRB(CUSpacing.lg, CUSpacing.xl, CUSpacing.lg, 100),
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text(
      ...
      child: Container(
        ...
        child: Row(
          children: [
            ...
            if (selected)
              Icon(CUIcons.checkCircle, color: theme.colorScheme.primary, size: CUSize.iconMedium)
            else
              Container(
                width: CUSize.iconMedium,
                height: CUSize.iconMedium,
                decoration: BoxDecoration(
...
class _CategoryCheckbox extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return CUOutlinedCard(
      ...
      child: Row(
        children: [
          Icon(icon, color: theme.colorScheme.onSurfaceVariant, size: CUSize.iconSmall),
          SizedBox(width: CUSpacing.md),
          Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
          ...
          if (selected)
            Icon(CUIcons.checkBox, color: theme.colorScheme.primary, size: CUSize.iconMedium)
          else
            Icon(CUIcons.checkBoxOutlineBlank, color: theme.colorScheme.outline, size: CUSize.iconMedium),
        ],
      ),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return CUDialog(
      ...
      child: Column(
        ...
        children: [
          Icon(CUIcons.checkCircle, size: CUSize.iconLarge * 2, color: CUColors.success),
