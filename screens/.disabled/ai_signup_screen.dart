...
class _AISignupScreenState extends State<AISignupScreen>
  ...
  Widget _buildChatMessage(ChatMessage message, CUThemeData theme) {
    return Container(
            ...
            child: Column(
              ...
              children: [
                if (message.showButton && message.buttonAction != null)
                  Container(
                    margin: EdgeInsets.only(top: CUSpacing.md),
                    child: CUButton(
                      onPressed: message.buttonAction,
                      text: message.buttonText ?? 'Get Started',
                      variant: CUButtonVariant.primary,
                      leadingIcon: CUIcons.rocketLaunch,
  ...
  Widget _buildTypingIndicator(CUThemeData theme) {
    return Container(
      margin: EdgeInsets.only(bottom: CUSpacing.md),
      child: Row(
        crossAxisAlignment: CrossAxisAlignment.start,
  ...
  Widget _buildDot(int index) {
    ...
    return Container(
      ...
      height: CUSpacing.xs,
      decoration: BoxDecoration(
        color: CUColors.grey.withOpacity(opacity),
        shape: BoxShape.circle,
      ),
    );
  }

  Widget _buildInputField(CUThemeData theme) {
    return Container(
      padding: EdgeInsets.all(CUSpacing.md),
      decoration: BoxDecoration(
        ...
        children: [
          ...
          CUButton(
            ...
            child: _isProcessing
                ...
                : CUIcon(CUIcons.send, size: CUSize.iconSm),
          ),
        ],
      ),
    );
