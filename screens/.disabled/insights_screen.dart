...
class _InsightsScreenState extends State<InsightsScreen> with SingleTickerProviderStateMixin {
              ...
              PieChartData(
                sections: _insights!.topCategories.map((entry) {
                  ...
                  return PieChartSectionData(
                    ...
                    color: color,
                    radius: 100,
                    titleStyle: CUTypography.bodySmall.copyWith(
                      fontWeight: FontWeight.bold,
    ...
    return CUCard(
      ...
      child: Padding(
        ...
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            CUIcon(icon, color: color, size: CUSize.icon.lg),
  ...
  Widget _buildCategoryItem(String category, double amount, double percentage, Color color) {
    ...
    return Padding(
      ...
      child: Row(
        children: [
          Container(
            width: CUSize.icon.sm,
            height: CUSize.icon.sm,
            decoration: BoxDecoration(
              color: color,
    ...
    return CUCard(
      ...
      child: CUListTile(
        ...
        subtitle: Text(
          ...
          style: CUTypography.bodySmall.copyWith(
            color: isSubscription ? CUColors.info : CUColors.purple,
          ),
        ),
        trailing: Text(
  ...
  Color _getCategoryColor(String category) {
    final colors = {
      'Food & Dining': CUColors.orange,
      'Shopping': CUColors.info,
      'Transportation': CUColors.success,
      'Entertainment': CUColors.purple,
      'Bills & Utilities': CUColors.error,
      'Healthcare': CUColors.pink,
      'Transfer': CUColors.grey,
      'Other': CUColors.teal,
    };
    return colors[category] ?? CUColors.grey;
  }
